...
/*    10/04/2019(ana-maria): Validated for Vivado 2018.2                      */
/*    10/04/2019(ana-maria): Validated for Vivado 2019.1  					  */
/* 	  09/16/20219(roxi-tudor): Validated for Vivado 2021.1	                  */
/*                                                                            */
/******************************************************************************/

/************ Include Files ************/

#include "PmodGPS/PmodGPS.h"
#include "xil_cache.h"
...
void DemoInitialize() {
   GPS_begin(&GPS, XPAR_PMODGPS_0_AXI_GPIO_0_BASEADDR,
		   XPAR_PMODGPS_0_AXI_UART16550_0_BASEADDR, PERIPHERAL_CLK);
   EnableCaches();
