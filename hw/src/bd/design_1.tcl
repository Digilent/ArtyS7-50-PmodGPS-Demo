...
# Hierarchical cell: PmodGPS_0
proc create_hier_cell_PmodGPS_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_PmodGPS_0() - Empty argument(s)!"}
     return
  }
  ...
  set_property -dict [ list \
   CONFIG.C_S_AXI_ACLK_FREQ_HZ {81247969} \
 ] $axi_uart16550_0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins Pmod_out_0] [get_bd_intf_pins pmod_bridge_0/Pmod_out]
  ...
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M00_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_gpio_0/S_AXI]
  connect_bd_intf_net -intf_net microblaze_0_axi_periph_M01_AXI [get_bd_intf_pins S_AXI1] [get_bd_intf_pins axi_uart16550_0/S_AXI]

  # Create port connections
  connect_bd_net -net axi_uart16550_0_ip2intc_irpt [get_bd_pins ip2intc_irpt] [get_bd_pins axi_uart16550_0/ip2intc_irpt]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins s_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_uart16550_0/s_axi_aclk]
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_uart16550_0/s_axi_aresetn]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: PmodGPS_0
  create_hier_cell_PmodGPS_0 [current_bd_instance .] PmodGPS_0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PmodGPS_0_Pmod_out_0 [get_bd_intf_ports Pmod_out] [get_bd_intf_pins PmodGPS_0/Pmod_out_0]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M01_AXI [get_bd_intf_pins axi_mem_intercon/M01_AXI] [get_bd_intf_pins microblaze_0_axi_intc/s_axi]
  ...
  connect_bd_intf_net -intf_net axi_mem_intercon_M03_AXI [get_bd_intf_pins PmodGPS_0/S_AXI] [get_bd_intf_pins axi_mem_intercon/M03_AXI]
  connect_bd_intf_net -intf_net axi_mem_intercon_M04_AXI [get_bd_intf_pins PmodGPS_0/S_AXI1] [get_bd_intf_pins axi_mem_intercon/M04_AXI]
  ...
  # Create port connections
  connect_bd_net -net PmodGPS_0_ip2intc_irpt [get_bd_pins PmodGPS_0/ip2intc_irpt] [get_bd_pins microblaze_0_axi_intc/intr]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins PmodGPS_0/s_axi_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_mem_intercon/M02_ACLK] [get_bd_pins axi_mem_intercon/M03_ACLK] [get_bd_pins axi_mem_intercon/M04_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_intc/processor_clk] [get_bd_pins microblaze_0_axi_intc/s_axi_aclk] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_mig_7series_0_81M_peripheral_aresetn [get_bd_pins PmodGPS_0/s_axi_aresetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/M02_ARESETN] [get_bd_pins axi_mem_intercon/M03_ARESETN] [get_bd_pins axi_mem_intercon/M04_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_intc/s_axi_aresetn] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_81M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodGPS_0/axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x40000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs PmodGPS_0/axi_gpio_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs PmodGPS_0/axi_uart16550_0/S_AXI/Reg] -force
  assign_bd_address -offset 0x44A00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces microblaze_0/Instruction] [get_bd_addr_segs PmodGPS_0/axi_uart16550_0/S_AXI/Reg] -force
